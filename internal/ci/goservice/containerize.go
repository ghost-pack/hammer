...
func (p *Pipeline) containerize(ctx context.Context) error {
	...
	if p.ComponentType() == "gocli" {
		baseImage = "us-central1-docker.pkg.dev/hammer-central-prod/hammer-toolkit/hammer-toolkit@sha256:09869a84ba42cb6da5af60f344a38f5ed9ebf2a459a5a24f2b49c47442439d64"
	} else {
